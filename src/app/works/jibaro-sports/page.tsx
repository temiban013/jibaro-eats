...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: 'https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_720/v1705793215/Jibaro-Works/IMG_1671_1_t4uxso.jpg'
  },
  twitter: {
    images: 'https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_720/v1705793215/Jibaro-Works/IMG_1671_1_t4uxso.jpg'
  }
...
export default async function Page() {
  ...
  return (
    <Suspense fallback={<SearchBarFallback/>}>
      <HomePage images={ cloudImages.reducedResults } jibaroName='Jibaro Sports'/>
    </Suspense>
  )
}