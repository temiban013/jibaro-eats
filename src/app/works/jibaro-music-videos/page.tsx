...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: 'https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_720/v1705794357/Jibaro-Works/image-asset_3_lfltj6.jpg'
  },
  twitter: {
    images: 'https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_720/v1705794357/Jibaro-Works/image-asset_3_lfltj6.jpg'
  }
...
export default async function Page() {
  return (
    <Suspense fallback={<SearchBarFallback/>}>
      <VideoPage videos={ videos } jibaroName='Jibaro Music Videos'/>
    </Suspense>
  )
}