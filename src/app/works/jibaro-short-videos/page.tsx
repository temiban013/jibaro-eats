...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: 'https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_720/v1705794360/Jibaro-Works/image-asset_5_lnl0o1.jpg'
  },
  twitter: {
    images: 'https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_720/v1705794360/Jibaro-Works/image-asset_5_lnl0o1.jpg'
  }
...
export default async function Page() {
  return (
    <Suspense fallback={<SearchBarFallback/>}>
      <VideoPage videos={ videos } jibaroName='Jibaro Short Videos'/>
    </Suspense>
  )
}