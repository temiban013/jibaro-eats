        ...
        <main className="mx-auto max-w-[1960px] p-4">
          ...
          <div className="after:content group relative mb-5 block w-full after:pointer-events-none">
              ...
              <div className="text-center bg-black text-white/80 sm:text-left sm:pl-12 pt-2 sm:pb-6">
                <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl">Jíbaro Works</h1>
            ...
            {images.map(({ id, public_id, format, title, blurDataUrl }) => (
              <div key={id} className="after:content group relative mb-5 block w-full after:pointer-events-none">
                ...
                <div onClick={() => navigateToTitle(title.toLowerCase())} className="absolute inset-0 flex items-center justify-center cursor-pointer">
